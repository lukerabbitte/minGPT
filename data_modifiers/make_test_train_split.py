...
df = pd.read_csv('../data/goodreads_eval.tsv', sep='\t')
...
train_data.to_csv('../data/goodreads_eval_80pc.tsv', sep='\t', index=False)
test_data.to_csv('../data/goodreads_eval_20pc.tsv', sep='\t', index=False)